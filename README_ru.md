...
- [2026-05-26] Выпущена версия **v1.1.9**! Полное описание — в [примечаниях к выпуску v1.1.9](https://qwenpaw.agentscope.io/release-notes).

  - **[v1.1.9] Добавлено**: режим Coding; маркетплейс навыков; десктопное приложение на Tauri; тайм-аут фоновых задач; изолированное выполнение cron-задач.
  - **[v1.1.9] Изменено**: обновление UI менеджера плагинов; валидация содержимого навыков; обновление UI консоли.
  - **[v1.1.9] Исправлено**: дедупликация и надёжность сообщений WeChat; декодирование китайских имён файлов в DingTalk; совместимость QwenPaw Pet с Windows.
  - **[v1.1.9] Новые участники**: @DICKQI, @Zachary-wW, @youngchan1988.

- [2026-05-19] Выпущена версия **v1.1.8**! Полное описание — в [примечаниях к выпуску v1.1.8](https://qwenpaw.agentscope.io/release-notes).

- [2026-05-14] Выпущена версия **v1.1.7**! Полное описание — в [примечаниях к выпуску v1.1.7](https://qwenpaw.agentscope.io/release-notes).

- [2026-05-09] Выпущена версия **v1.1.6**! Полное описание — в [примечаниях к выпуску v1.1.6](https://qwenpaw.agentscope.io/release-notes).
...
Спасибо всем за поддержку на этом пути.
С сегодняшнего дня QwenPaw остаётся с вами и растёт вместе с вами.
...
- **Веб-аутентификация** — Необязательная защита входа в консоль. По умолчанию отключена​; установите `QWENPAW_AUTH_ENABLED=true` для включения. Подробнее см. [Веб-аутентификация](https://qwenpaw.agentscope.io/docs/security#Web-Authentication).
