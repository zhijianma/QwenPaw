...
- [2026-05-09] Выпущена версия **v1.1.6**! Полное описание — в [примечаниях к выпуску v1.1.6](https://qwenpaw.agentscope.io/release-notes).
  ...
  - **[v1.1.6] Добавлено**: автогенерация заголовков сессий через LLM; графики трендов использования токенов; рендеринг диаграмм Mermaid; интерактивные карточки одобрения в Feishu/WeCom; провайдеры Volcano Engine и Aliyun Token Plan; CLI для установки/удаления/тестирования навыков; API статуса агента; изоляция сессий Cron; плагин GPT Image 2.
  - **[v1.1.6] Производительность**: оптимизация рендеринга консоли; оптимизация навигации по истории чата; очистка опроса QR-кода.
  - **[v1.1.6] Исправлено**: тайм-аут выполнения MCP и утечка жизненного цикла; горячая перезагрузка и сохранение конфигурации агента.
  - **[v1.1.6] Новые участники**: @karls0r, @Jailtonfonseca, @hllqkb, @yutai78786, @tqjason, @JingHou1215, @wjt0321, @1105623876, @Keillion, @q1023884985.

- [2026-04-29] Выпущена версия **v1.1.5**! Полное описание — в [примечаниях к выпуску v1.1.5](https://qwenpaw.agentscope.io/release-notes).

- [2026-04-24] Выпущена версия **v1.1.4**! Полное описание — в [примечаниях к выпуску v1.1.4](https://qwenpaw.agentscope.io/release-notes).
